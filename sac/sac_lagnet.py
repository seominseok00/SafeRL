...
def sac_lagnet(env_fn, actor_critic=MLPActorCritic, ac_kwargs=dict(), seed=0,
        epochs=300, steps_per_epoch=4000, replay_size=int(1e6), batch_size=100,
        gamma=0.99, polyak=0.995, penalty_net=MLPPenalty, pi_lr=3e-4, q_lr=1e-3, alpha_lr=1e-3, penalty_lr=1e-5,
    ...
    penalty_net = penalty_net(obs_dim ,act_dim, **ac_kwargs)
