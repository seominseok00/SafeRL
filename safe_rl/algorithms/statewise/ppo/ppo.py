...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Statewise PPO')
    parser.add_argument('--config', type=str, default='configs/statewise/ppo/ppo.yaml', help='Path to the YAML configuration file (relative to project root)')
